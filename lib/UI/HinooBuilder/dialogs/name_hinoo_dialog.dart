...
class NameHinooDialog extends StatefulWidget {
  const NameHinooDialog({super.key, this.initialValue});

  final String? initialValue;

  @override
  State<NameHinooDialog> createState() => _NameHinooDialogState();
}

class _NameHinooDialogState extends State<NameHinooDialog> {
