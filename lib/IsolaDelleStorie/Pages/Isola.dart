...
class Isola extends StatefulWidget {
  const Isola({super.key});


  @override
  State<Isola> createState() => _IsolaState();
}

class _IsolaState extends State<Isola> {
                    ...
                    Container(
                      ...
                      child:Column(
                        ...
                        children: [
                          ...
                          IsolaDelleStoreContentManager.getContent(IsolaDelleStoreContentManager.homeDescription),
                          Padding(padding: EdgeInsets.only(top: 5.h)),
                        ],
                      ),
                    ),
